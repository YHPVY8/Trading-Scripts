...
# ---------- Step 1: Load ALL source data (2hr prices) ----------
df = fetch_all_rows("es_2hr", order_col="time", page_size=1000)
if df.empty:
    raise RuntimeError("es_2hr returned no rows; cannot compute pivots.")

print(f"Loaded {len(df):,} rows from es_2hr.")
